...
def main():
    ...
    parser.add_argument('--device', default='npu', help='cuda device, i.e. 0 or 0,1,2,3 or cpu or npu')
    ...
    parser.add_argument('--addr', default='10.1.6.11', type=str, help='DDP master node IP')
