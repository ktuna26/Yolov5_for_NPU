...
then
   ...
   python3.7 train.py --data data/coco.yaml --cfg models/yolov5x.yaml --addr 127.0.0.1 --weights weights/yolov5x.pt --batch-size 32 --local_rank 0 --device npu --device-num 8 --cache-images
fi
